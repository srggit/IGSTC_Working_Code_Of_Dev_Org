angular.module('cp_app').controller('PEFFARDocUpload_Ctrl', function($scope,$rootScope) {
    $scope.objContact={};
    $scope.Traveller={};
    $scope.Visa={};
        ...
        IndustrialFellowshipController.getDocUploadDet($rootScope.userHashId, function (result, event) {
            ...
            $scope.objProposal=result.Proposals__r;
                  ...
                  if($scope.objProposal.Decision_Letter_Sent__c){                    
                    if($scope.objProposal.Travel_Form_Status__c!=undefined && $scope.objProposal.Travel_Form_Status__c=="Submitted"){
    ...
    $scope.getProjectdetils = function () {
        debugger;
        ApplicantPortal_Contoller.getAllUserDoc($rootScope.contactId, function (result, event) {
            debugger
